// Start of UML-model
=== Pakke: «ApplicationSchema» Utkast-FKB-Bygning-5.1
...
|designation
|"Product specification FKB-Bygning 5.1"@en
...
|targetNamespace
|http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Bygning/5.1
...
|Realisering av: 
|/SOSI Generell objektkatalog/FKB Generell del/FKB Generell del-5.0/Generelle elementer::«FeatureType» KvalitetPåkrevd +
|Realisering av: 
|«ApplicationSchema» Generelle typer 5.1/SOSI_Fellesegenskaper og SOSI_Objekt::«FeatureType» SOSI_Objekt +
|===
...
|===
|*Rollenavn:* 
|*beskrivesAvTaksprangBunn*
 
|Definisjon:
|Bygning kjenner hvilke beskrivede bygningsdetaljer som tilhører bygningen
